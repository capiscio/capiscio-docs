...
```go
import "github.com/capiscio/capiscio-core/pkg/simpleguard"
```
...
<a name="Middleware"></a>
## func [Middleware](<https://github.com/capiscio/capiscio-core/blob/main/pkg/simpleguard/middleware.go#L20>)
...
<a name="Claims"></a>
## type [Claims](<https://github.com/capiscio/capiscio-core/blob/main/pkg/simpleguard/types.go#L9-L16>)
...
<a name="Config"></a>
## type [Config](<https://github.com/capiscio/capiscio-core/blob/main/pkg/simpleguard/types.go#L19-L25>)
...
### func \(\*SimpleGuard\) [SignOutbound](<https://github.com/capiscio/capiscio-core/blob/main/pkg/simpleguard/guard.go#L62>)
...
### func \(\*SimpleGuard\) [VerifyInbound](<https://github.com/capiscio/capiscio-core/blob/main/pkg/simpleguard/guard.go#L92>)
